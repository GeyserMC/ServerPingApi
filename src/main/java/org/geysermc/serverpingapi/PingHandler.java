...
public class PingHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        hostname = exchange.getRequestHeaders().containsKey("X-Forwarded-For") ? exchange.getRequestHeaders().getFirst("X-Forwarded-For").split(",")[0] : exchange.getRemoteAddress().getHostString();
